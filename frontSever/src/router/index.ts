...
const routes = [
    { path: '/', component: () => import('@/views/Home/HomeIndex.vue'), meta: { title: '🦄欢迎来到潘潘大王的地盘！',keepAlive: true }},
    { path: '/Task', component: () => import('@/views/Task/TaskIndex.vue'), meta: { title: '🦄欢迎来到潘潘大王的任务中心',keepAlive: true } },
    { path: '/Produce', component: () => import('@/views/Produce/ProduceIndex.vue'), meta: { title: '🦄欢迎来到潘潘大王的杂货铺',keepAlive: true } },
    { path: '/Room', component: () => import('@/views/Room/RoomIndex.vue'), meta: { title: '🦄欢迎来到潘潘大王的藏宝箱',keepAlive: true } },
    { path: '/User', component: () => import('@/views/User/UserIndex.vue'), meta: { title: '🦄给潘潘大王报上名来！',keepAlive: true } },
    ...
    // 登录
    { path: '/login', component: () => import('@/views/login/loginIndex.vue'), meta: { title: '欢迎来到潘潘大王的地盘' } },
    // 注册
    { path: '/userAdd', component: () => import('@/views/Add/UserAddIndex.vue'), meta: { title: '给潘潘大王报上名来！！！' } },
