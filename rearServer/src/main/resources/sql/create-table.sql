...
(
    ...
    userImage    text                                           null,
    credit       int         default 0                          not null comment 'pp币',
...
(
    ...
    allCredit       int default 0 null comment '用户获得pp币总数',
    dayCredit       int default 0 null comment '用户今日获得pp币',
...
(
    ...
    produceCredit int                  null comment '单个任务pp币',
...
(
    ...
    taskCredit   int        default 0 null comment '任务pp币',
